  ...
  <div className='bg-sky-900 p-3 text-white rounded-full  flex justify-center'>
    <FaSearch />
        ...
        <div className='bg-white p-2 rounded-2xl flex'>
          <button className='font-bold text-sky-900' onClick={()=>navigate('/admin-add-subject')}>ADD SUBJECT</button>
        </div>
        </div>
      ...
      <Table className='min-w-2'>
        <TableHead>
          <TableRow className='bg-green-300'>
            <StyledTableCell onClick={()=>sorting('column1')} >No</StyledTableCell>
            <StyledTableCell onClick={()=>sorting('name')}>Name of Subject</StyledTableCell>
            <StyledTableCell onClick={()=>sorting('branch.name')}>Name of Branch</StyledTableCell>
            <StyledTableCell onClick={()=>sorting('column1')}>Actions</StyledTableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {subjects.map((subject,index)=>(
            <TableRow key={subject._id} className='uppercase bg-slate-300'>
                    ...
                    <TableCell>
                    <button onClick={()=>(subject._id)} className='bg-sky-900 font-semibold text-white m-2 w-20 p-2 rounded-xl'>EDIT</button>
