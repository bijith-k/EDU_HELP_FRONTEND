...
const ManageQuestionPaper = () => {
  ...
  return (
     <div className='bg-sky-900 flex overflow-x-hidden'>
      ...
      <p className='bg-white w-full p-3 my-5 uppercase font-bold text-center'>manage question papers</p>
      ...
      <Table className='min-w-2'>
        <TableHead>
          <TableRow className='bg-green-300'>
            ...
            <StyledTableCell onClick={()=>sorting('name')}>Name of exam</StyledTableCell>
