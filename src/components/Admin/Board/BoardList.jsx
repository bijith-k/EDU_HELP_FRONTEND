  ...
  <div className='bg-sky-900 p-3 text-white rounded-full  flex justify-center'>
    <FaSearch />
        ...
        <div className='bg-white p-2 rounded-2xl flex'>
          <button className='font-bold text-sky-900' onClick={()=>navigate('/admin-add-board')}>ADD BOARD</button>
        </div>
        </div>
      ...
      <Table className='min-w-2'>
        <TableHead>
          <TableRow className='bg-green-300'>
            ...
            <StyledTableCell onClick={()=>sorting('column1')}>Name of Board/University</StyledTableCell>
        ...
        <TableBody>
          ...
          <TableRow key={board._id} className='bg-gray-400 uppercase'>
            ...
            <TableCell>
<button onClick={()=>(board._id)} className='bg-sky-900 font-semibold text-white m-2 w-20 p-2 rounded-xl'>EDIT</button>
