      ...
      {loading ? (
        <Box className="flex flex-col md:flex-row gap-2 mt-24">
          <Box
            ...
            boxShadow="lg"
            bg="white"
            className="mt-5 mx-auto h-96 md:w-3/12 w-80 rounded-3xl"
          >
          ...
          <Box
            ...
            boxShadow="lg"
            bg="white"
            className="mt-5 mx-auto h-96 md:w-3/12 w-80 md:block hidden rounded-3xl"
          >
            <Skeleton height="28" mt="6" className="mx-auto" />
            <SkeletonText
              mt="10"
          ...
          <Box
            ...
            boxShadow="lg"
            bg="white"
            className="mt-5 mx-auto md:block hidden h-96 md:w-3/12 w-80 rounded-3xl"
          >
            <Skeleton height="28" mt="6" className="mx-auto" />
            <SkeletonText
              mt="10"
