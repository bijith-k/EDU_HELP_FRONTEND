...
// import logo from '../../../assets/eduhelpLogo.png'
import logo from "../../../assets/logoWhite.png";

const Footer = () => {
  return (
    <div className="relative z-10 bg-gray-800 h-fit ">
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className=" w-full">
              ...
              <p className="text-body-color mb-7 text-base">
                Edu-Help is a learning platform for students. Here you can found
                or add study materials for your study.
              </p>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="text-body-color text-base">&copy; 2023 EDU-HELP</p>
            </div>
          </div>
        </div>
      </div>
